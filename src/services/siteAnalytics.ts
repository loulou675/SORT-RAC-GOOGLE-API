...
const devStatsSchema = z.object({
  ...
  totals: z.object({
    ...
    newVisitors: z.number().int(),
    returningVisitors: z.number().int(),
    repeatVisitors: z.number().int(),
    engagedSessions: z.number().int(),
    bounceRate: z.number(),
    repeatVisitRate: z.number(),
    engagementRate: z.number(),
    avgSessionsPerVisitor: z.number(),
  }),
  scan: z.object({
    scanStarts: z.number().int(),
    scanSuccesses: z.number().int(),
    scanErrors: z.number().int(),
    scanSuccessRate: z.number(),
    feedbackSubmissions: z.number().int(),
    surveySubmissions: z.number().int(),
  }),
  ...
  visitFrequency: z.array(z.object({ bucket: z.string(), visitors: z.number().int() })),
  features: z.array(z.object({ label: z.string(), uses: z.number().int() })),
  pages: z.array(z.object({ path: z.string(), views: z.number().int() })),
  devices: z.array(z.object({ label: z.string(), visitors: z.number().int() })),
  sources: z.array(z.object({ label: z.string(), visitors: z.number().int() })),
})
